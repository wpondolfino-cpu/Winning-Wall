...
type AdminTab  = "workouts" | "leaderboard" | "players" | "admin";
...
export default function App() {
  ...
  if (authState === "loading") {
    return (
      <div style={{
        ...
        justifyContent: "center", background: "#0a0c14", flexDirection: "column", gap: 16,
      }}>
  ...
  // ── Invite link clicked — force set password first ──
  if (authState === "invite") {
    return (
      <ChangePassword
        title="Welcome to AHS Winning Wall! 🏀"
        subtitle="Your account is ready. Please create your own personal password before continuing."
  ...
  // ── Must change password (added manually by coach/admin) ──
  if (profile.must_change_password) {
    return (
      <ChangePassword
        title="Welcome to AHS Winning Wall! 🏀"
        subtitle="Your account was set up by a coach. Please create your own personal password before continuing."
        onComplete={() => window.location.reload()}
      />
    );
  }
