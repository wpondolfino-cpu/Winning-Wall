...
export default function CoachPanel({ workouts, onPublished, coachId, coachName, isAdmin, openWorkoutId, onDeepLinkHandled }: Props) {
  ...
  /**
   * Puts a group's scores back on the leaderboard. Nothing else.
   *
   * A run prompt lived here briefly and was moved to "Run again" in Group
   * Manager. This button is usually an UNDO -- you pulled a group off the
   * leaderboard and want it back exactly as it was -- so offering to wipe
   * the board here would be a trap. "Run again" is the deliberate act.
   */
