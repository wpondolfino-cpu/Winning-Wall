...
type PlayerTab = "workouts" | "leaderboard" | "progress" | "h2h";
  ...
  return (
    <div id="app-screen" className="screen active">
      ...
      <div className="app-header">
        ...
        <div className="header-user">{activeProfile?.name ?? profile.name}</div>
      ...
      <div className="app-body">
        ...
        <div className="main-content">
          ...
          {isPlayer && playerTab === "progress" && (
            <ProgressPanel profile={displayProfile} myScores={myScores} workouts={workouts} onProfileUpdated={handleProfileUpdated} />
          )}
